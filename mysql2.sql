...
('juliana','1997-12-25',NULL,'310.60','troca de amortecedor',NULL,'sala b','Preventiva','modelo 02 e marca 02', 'Substituição dos filtros'),
('fernando','2004-04-18',NULL,'180.45','troca de pneu',NULL,'sala c','Corretiva','modelo 03 e marca 03', 'Limpeza dos filtros de ar'),
('beatriz','2000-01-07',NULL,'270.20','troca de bateria',NULL,'sala d','Preventiva','modelo 04 e marca 04', 'Limpeza de dreno'),
('lucas','2005-09-14',NULL,'195.75','troca de cabo',NULL,'sala e','Corretiva','modelo 05 e marca 05', 'Medição de tensão elétrica');
use controladores_de_temperatura;
